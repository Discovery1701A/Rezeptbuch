...
let pastaRecipe = Recipe(
    ...
    image: "spaghetti-mit-schneller-tomatensosse.jpg"
)
let brownie = Recipe(title: "Brownie", ingredients: ["250g Schokolade", "250g Butter", "1TL Vanille-Extrakt", "350g Zucker", "6 Eier", "150g Mehl", "200g Schokostücke"], instructions: ["Offen auf 180C° vorheizen","Schokolade und Butter über einem Wasserbad schmelzen", "Eier mit Vanille-Extrakt und Zucker aufschlagen", "abgekühlte Schokoladen-Butter-Masse langsam zu der Eiermasse geben", "erst Mehl und dann die Schokostücke hinzugeben", "Teig in eine Form oder aufs Backblech geben", "30 minuten in den Backoffen"])
